...
export async function seedDatabase() {
  ...
  await db.insert(products).values([
    ...
    { name: "CAPACITOR ELITE 5UF 250 VAC 2 FIOS 220V", sku: "ELE003", categoryId: eletricaParent?.id, price: 1590, image: "https://www.eletricenter.com/product_images/r/681/capacitor_quadrado__52563_std.jpg", description: "Capacitor para ventilador e motor elétrico. 5µF, 250VAC, 2 fios, 220V. Material ABS anti-chamas.", packageType: "Unidade", stock: 200, minStock: 30, status: "Ativo", specs: { "Capacitância": "5µF", "Tensão": "250VAC", "Fios": "2", "Voltagem": "220V", "Frequência": "50/60Hz" } },
  ]);
